...
public class Komponen extends JFrame {
    ...
    protected JLabel labelJenis = new JLabel("Jenis     : ");
    protected JLabel labelPenerima = new JLabel("Penerima`: ");
    ...
    protected JTextField txtJenis = new JTextField();
    protected JTextField txtPenerima = new JTextField();
    ...
    protected JButton btnPengirim = new JButton("Pengirim");
